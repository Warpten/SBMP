...
/// Size: 0x0960 (2400 bytes) (0x000880 - 0x000960) align 16 MaxSize: 0x0958
class UDestructibleComponent : public USkinnedMeshComponent
{ 
public:
    bool                                               bFractureEffectOverride : 1;                                // 0x0880:0 (0x0001)
    unsigned char                                      UnknownData00_5[0x7];                                       // 0x0881   (0x0007) MISSED
    TArray<FFractureEffect>                            FractureEffects;                                            // 0x0888   (0x0010)
    bool                                               bEnableHardSleeping;                                        // 0x0898   (0x0001)
    unsigned char                                      UnknownData01_6[0x3];                                       // 0x0899   (0x0003) MISSED
    float                                              LargeChunkThreshold;                                        // 0x089C   (0x0004)
    unsigned char                                      UnknownData02_6[0x10];                                      // 0x08A0   (0x0010) MISSED
    FMulticastInlineDelegate                           OnComponentFracture;                                        // 0x08B0   (0x0010)
    unsigned char                                      UnknownData03_7[0x98];                                      // 0x08C0   (0x0098) MISSED
...
/// Size: 0x0460 (1120 bytes) (0x0003C0 - 0x000460) align 8 MaxSize: 0x0460
...
public:
    ...
    unsigned char                                      UnknownData00_7[0x8];                                       // 0x0458   (0x0008) MISSED
};
