...
{ 
	...
	unsigned char                                      UnknownData03_6[0x20];                                      // 0x0010   (0x0020)  MISSED
...
{ 
public:
	unsigned char                                      UnknownData05_8[0x8];                                       // 0x0028   (0x0008)  MISSED
	...
	unsigned char                                      UnknownData06_6[0x10];                                      // 0x00B0   (0x0010)  MISSED
...
public:
	...
	unsigned char                                      UnknownData01_7[0x48];                                      // 0x0058   (0x0048)  MISSED
};
...
{ 
	...
	unsigned char                                      UnknownData12_6[0x1];                                       // 0x003B   (0x0001)  MISSED
...
{ 
public:
	unsigned char                                      UnknownData03_8[0x8];                                       // 0x0560   (0x0008)  MISSED
	...
	unsigned char                                      UnknownData04_6[0x48];                                      // 0x05D8   (0x0048)  MISSED
