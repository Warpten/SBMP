...
public:
    ...
    unsigned char                                      UnknownData05_6[0x20];                                      // 0x0540   (0x0020) MISSED
    ...
    unsigned char                                      UnknownData06_6[0x7];                                       // 0x0569   (0x0007) MISSED
    ...
    unsigned char                                      UnknownData07_6[0x7];                                       // 0x0581   (0x0007) MISSED
    ...
    unsigned char                                      UnknownData08_6[0x3];                                       // 0x0595   (0x0003) MISSED
