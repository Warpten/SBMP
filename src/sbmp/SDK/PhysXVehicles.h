...
{ 
public:
	unsigned char                                      UnknownData08_8[0x8];                                       // 0x0158   (0x0008)  MISSED
	...
	unsigned char                                      UnknownData09_3[0x3];                                       // 0x0161   (0x0003)  MISSED
	bool                                               bWasAvoidanceUpdated : 1;                                   // 0x0164:0 (0x0001)  
	unsigned char                                      UnknownData10_5[0x3];                                       // 0x0165   (0x0003)  MISSED
	float                                              Mass;                                                       // 0x0168   (0x0004)  
	unsigned char                                      UnknownData11_6[0x4];                                       // 0x016C   (0x0004)  MISSED
	...
	unsigned char                                      UnknownData12_6[0x4];                                       // 0x01C4   (0x0004)  MISSED
	TArray<class UVehicleWheel*>                       Wheels;                                                     // 0x01C8   (0x0010)  
	unsigned char                                      UnknownData13_6[0x18];                                      // 0x01D8   (0x0018)  MISSED
	...
	unsigned char                                      UnknownData14_6[0x4];                                       // 0x0238   (0x0004)  MISSED
...
{ 
public:
	unsigned char                                      UnknownData02_8[0x798];                                     // 0x02C8   (0x0798)  MISSED
...
public:
	...
	unsigned char                                      UnknownData06_6[0x2];                                       // 0x0032   (0x0002)  MISSED
	...
	unsigned char                                      UnknownData09_6[0x4];                                       // 0x0094   (0x0004)  MISSED
	...
	unsigned char                                      UnknownData10_6[0x4];                                       // 0x00B0   (0x0004)  MISSED
...
{ 
	unsigned char                                      UnknownData01_1[0x18];                                      // 0x00C8   (0x0018)  MISSED
};
...
{ 
	unsigned char                                      UnknownData01_1[0x10];                                      // 0x0770   (0x0010)  MISSED
};
