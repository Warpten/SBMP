...
{ 
	...
	unsigned char                                      UnknownData06_6[0x3];                                       // 0x0001   (0x0003)  MISSED
	...
	unsigned char                                      UnknownData08_6[0x4];                                       // 0x002C   (0x0004)  MISSED
	...
	unsigned char                                      UnknownData10_6[0x3];                                       // 0x0059   (0x0003)  MISSED
	float                                              StereoWidenerFilterFrequency;                               // 0x005C   (0x0004)  
	float                                              StereoWidenerFilterQ;                                       // 0x0060   (0x0004)  
	unsigned char                                      UnknownData11_7[0x4];                                       // 0x0064   (0x0004)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData05_7[0x8];                                       // 0x00F0   (0x0008)  MISSED
};
