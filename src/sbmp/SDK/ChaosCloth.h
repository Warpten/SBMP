...
public:
	...
	unsigned char                                      UnknownData10_6[0x2];                                       // 0x005A   (0x0002)  MISSED
	...
	unsigned char                                      UnknownData11_6[0x3];                                       // 0x0069   (0x0003)  MISSED
	...
	unsigned char                                      UnknownData13_6[0x3];                                       // 0x0079   (0x0003)  MISSED
	float                                              DragCoefficient;                                            // 0x007C   (0x0004)  
	float                                              LiftCoefficient;                                            // 0x0080   (0x0004)  
	bool                                               bUseGravityOverride;                                        // 0x0084   (0x0001)  
	unsigned char                                      UnknownData14_6[0x3];                                       // 0x0085   (0x0003)  MISSED
	...
	unsigned char                                      UnknownData15_7[0x1];                                       // 0x00AF   (0x0001)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData05_7[0x2];                                       // 0x0056   (0x0002)  MISSED
};
...
{ 
public:
	unsigned char                                      UnknownData01_1[0x28];                                      // 0x0030   (0x0028)  MISSED
};
