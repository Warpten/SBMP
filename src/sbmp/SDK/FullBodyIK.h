...
{ 
	...
	unsigned char                                      UnknownData05_6[0x2];                                       // 0x004E   (0x0002)  MISSED
...
{ 
	...
	unsigned char                                      UnknownData02_6[0xA];                                       // 0x0006   (0x000A)  MISSED
...
{ 
	unsigned char                                      UnknownData01_2[0x198];                                     // 0x0000   (0x0198)  MISSED
};
...
{ 
	...
	unsigned char                                      UnknownData04_6[0x1];                                       // 0x00BF   (0x0001)  MISSED
	FFBIKDebugOption                                   DebugOption;                                                // 0x00C0   (0x0050)  
	FRigUnit_FullbodyIK_WorkData                       WorkData;                                                   // 0x0110   (0x0198)  
	unsigned char                                      UnknownData05_7[0x8];                                       // 0x02A8   (0x0008)  MISSED
};
