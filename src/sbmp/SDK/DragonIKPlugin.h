...
/// Size: 0x07D0 (2000 bytes) (0x0000C8 - 0x0007D0) align 16 MaxSize: 0x07D0
...
{ 
    ...
    unsigned char                                      UnknownData01_6[0x88];                                      // 0x0140   (0x0088) MISSED
    TArray<FDragonData_ArmsData>                       Aiming_Hand_Limbs;                                          // 0x01C8   (0x0010)
    unsigned char                                      UnknownData02_6[0x38];                                      // 0x01D8   (0x0038) MISSED
    ...
    unsigned char                                      UnknownData03_6[0x4];                                       // 0x023C   (0x0004) MISSED
    ...
    unsigned char                                      UnknownData04_6[0x1];                                       // 0x0356   (0x0001) MISSED
    bool                                               enable_solver;                                              // 0x0357   (0x0001)
    EInterpoLocation_Type_Plugin                       loc_interp_type;                                            // 0x0358   (0x0001)
    unsigned char                                      UnknownData05_6[0x3];                                       // 0x0359   (0x0003) MISSED
    float                                              Interpolation_Speed;                                        // 0x035C   (0x0004)
    unsigned char                                      UnknownData06_6[0x50];                                      // 0x0360   (0x0050) MISSED
    FVector                                            LookAt_Axis;                                                // 0x03B0   (0x000C)
    unsigned char                                      UnknownData07_6[0x34];                                      // 0x03BC   (0x0034) MISSED
    FVector                                            TargetOffset;                                               // 0x03F0   (0x000C)
    unsigned char                                      UnknownData08_6[0x74];                                      // 0x03FC   (0x0074) MISSED
    FTransform                                         Debug_LookAtLocation;                                       // 0x0470   (0x0030)
    unsigned char                                      UnknownData09_7[0x330];                                     // 0x04A0   (0x0330) MISSED
};
...
{ 
    ...
    unsigned char                                      UnknownData00_6[0x78];                                      // 0x00E8   (0x0078) MISSED
    EIK_Type_Plugin                                    ik_type;                                                    // 0x0160   (0x0001)
    EIKTrace_Type_Plugin                               trace_type;                                                 // 0x0161   (0x0001)
    unsigned char                                      UnknownData01_6[0x2];                                       // 0x0162   (0x0002) MISSED
    ...
    unsigned char                                      UnknownData04_6[0x5];                                       // 0x01A3   (0x0005) MISSED
    ...
    unsigned char                                      UnknownData07_6[0x8];                                       // 0x0320   (0x0008) MISSED
    ...
    unsigned char                                      UnknownData08_6[0x2];                                       // 0x033D   (0x0002) MISSED
    bool                                               Enable_Pitch;                                               // 0x033F   (0x0001)
    bool                                               Enable_Roll;                                                // 0x0340   (0x0001)
    unsigned char                                      UnknownData09_6[0x3];                                       // 0x0341   (0x0003) MISSED
    FVector                                            character_direction_vector_CS;                              // 0x0344   (0x000C)
    unsigned char                                      UnknownData10_6[0xD8];                                      // 0x0350   (0x00D8) MISSED
    ...
    unsigned char                                      UnknownData11_7[0x8];                                       // 0x0438   (0x0008) MISSED
};

/// Struct /Script/DragonIKPlugin.AnimNode_DragonSpineSolver
/// Size: 0x0630 (1584 bytes) (0x000010 - 0x000630) align 16 MaxSize: 0x0630
struct FAnimNode_DragonSpineSolver : FAnimNode_Base
{ 
    FDragonData_MultiInput                             dragon_input_data;                                          // 0x0010   (0x0020)
    unsigned char                                      UnknownData00_6[0x70];                                      // 0x0030   (0x0070) MISSED
    ...
    unsigned char                                      UnknownData05_6[0x3];                                       // 0x0111   (0x0003) MISSED
    ...
    unsigned char                                      UnknownData07_6[0x1];                                       // 0x0123   (0x0001) MISSED
    float                                              Trace_Radius;                                               // 0x0124   (0x0004)
    EIKTrace_Type_Plugin                               Spine_Trace_Type;                                           // 0x0128   (0x0001)
    unsigned char                                      UnknownData08_6[0x3];                                       // 0x0129   (0x0003) MISSED
    float                                              Spine_Trace_Radius;                                         // 0x012C   (0x0004)
    bool                                               UseDynamicCheckBySpeed;                                     // 0x0130   (0x0001)
    unsigned char                                      UnknownData09_6[0x3];                                       // 0x0131   (0x0003) MISSED
    ...
    unsigned char                                      UnknownData10_6[0x3];                                       // 0x015D   (0x0003) MISSED
    ...
    unsigned char                                      UnknownData11_6[0xA];                                       // 0x017A   (0x000A) MISSED
    float                                              ActualAlpha;                                                // 0x0184   (0x0004)
    float                                              PreActualAlpha;                                             // 0x0188   (0x0004)
    bool                                               bResetEvaluate;                                             // 0x018C   (0x0001)
    unsigned char                                      UnknownData12_6[0xB];                                       // 0x018D   (0x000B) MISSED
    ...
    unsigned char                                      UnknownData13_6[0x3];                                       // 0x01A1   (0x0003) MISSED
    float                                              Slanted_Height_Up_Offset;                                   // 0x01A4   (0x0004)
    unsigned char                                      UnknownData14_6[0x4];                                       // 0x01A8   (0x0004) MISSED
    float                                              Slanted_Height_Down_Offset;                                 // 0x01AC   (0x0004)
    bool                                               reverse_fabrik;                                             // 0x01B0   (0x0001)
    unsigned char                                      UnknownData15_6[0x7];                                       // 0x01B1   (0x0007) MISSED
    bool                                               Calculation_To_RefPose;                                     // 0x01B8   (0x0001)
    unsigned char                                      UnknownData16_6[0x3];                                       // 0x01B9   (0x0003) MISSED
    ...
    unsigned char                                      UnknownData17_6[0xE];                                       // 0x01EA   (0x000E) MISSED
    float                                              rotation_power_between;                                     // 0x01F8   (0x0004)
    bool                                               Use_Automatic_Fabrik_Selection;                             // 0x01FC   (0x0001)
    unsigned char                                      UnknownData18_6[0x3];                                       // 0x01FD   (0x0003) MISSED
    ...
    unsigned char                                      UnknownData23_6[0x4];                                       // 0x02B0   (0x0004) MISSED
