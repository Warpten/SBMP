...
{ 
	...
	unsigned char                                      UnknownData03_6[0x1];                                       // 0x0001   (0x0001)  MISSED
	int16_t                                            Int16;                                                      // 0x0002   (0x0002)  
	int32_t                                            Int32;                                                      // 0x0004   (0x0004)  
	int64_t                                            int64;                                                      // 0x0008   (0x0008)  
	char                                               UInt8;                                                      // 0x0010   (0x0001)  
	unsigned char                                      UnknownData04_6[0x1];                                       // 0x0011   (0x0001)  MISSED
...
{ 
	...
	unsigned char                                      UnknownData05_7[0xC];                                       // 0x0084   (0x000C)  MISSED
};
