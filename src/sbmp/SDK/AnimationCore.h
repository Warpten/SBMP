...
{ 
public:
    TMap<FName, TWeakObjectPtr<UObject*>>              DataSources;                                                // 0x0028   (0x0050) 
};
...
{ 
    ...
    unsigned char                                      UnknownData01_7[0xF];                                       // 0x0001   (0x000F) MISSED
};
...
{ 
    ...
    unsigned char                                      UnknownData03_7[0x5];                                       // 0x000B   (0x0005) MISSED
};
