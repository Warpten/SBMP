...
public:
    ...
    unsigned char                                      UnknownData03_7[0x80];                                      // 0x0058   (0x0080) MISSED
};
...
{ 
    ...
    unsigned char                                      UnknownData07_6[0x3];                                       // 0x0001   (0x0003) MISSED
    float                                              ValidEngineTime;                                            // 0x0004   (0x0004) 
    float                                              EngineTimeOffset;                                           // 0x0008   (0x0004) 
    unsigned char                                      UnknownData08_6[0x4];                                       // 0x000C   (0x0004) MISSED
    ...
    unsigned char                                      UnknownData10_6[0x3];                                       // 0x0025   (0x0003) MISSED
    ...
    unsigned char                                      UnknownData12_6[0x4];                                       // 0x003C   (0x0004) MISSED
    ...
    unsigned char                                      UnknownData13_7[0x7];                                       // 0x0051   (0x0007) MISSED
};
...
{ 
    unsigned char                                      UnknownData01_1[0x10];                                      // 0x0008   (0x0010) MISSED
};
...
{ 
    unsigned char                                      UnknownData01_2[0x160];                                     // 0x0000   (0x0160) MISSED
};
...
{ 
    ...
    unsigned char                                      UnknownData01_7[0x20];                                      // 0x0080   (0x0020) MISSED
};
...
{ 
    ...
    unsigned char                                      UnknownData01_7[0xB];                                       // 0x00E5   (0x000B) MISSED
};
