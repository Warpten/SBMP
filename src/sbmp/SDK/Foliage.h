...
public:
	...
	unsigned char                                      UnknownData01_7[0x8];                                       // 0x07A8   (0x0008)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData19_6[0x3];                                       // 0x0045   (0x0003)  MISSED
	float                                              SingleInstanceModeRadius;                                   // 0x0048   (0x0004)  
	EFoliageScaling                                    Scaling;                                                    // 0x004C   (0x0001)  
	unsigned char                                      UnknownData20_6[0x3];                                       // 0x004D   (0x0003)  MISSED
	...
	unsigned char                                      UnknownData27_5[0x3];                                       // 0x0105   (0x0003)  MISSED
	...
	unsigned char                                      UnknownData28_6[0x3];                                       // 0x013D   (0x0003)  MISSED
	...
	unsigned char                                      UnknownData29_5[0x2];                                       // 0x014A   (0x0002)  MISSED
	int32_t                                            OverriddenLightMapRes;                                      // 0x014C   (0x0004)  
	ELightmapType                                      LightmapType;                                               // 0x0150   (0x0001)  
	unsigned char                                      UnknownData30_6[0x3];                                       // 0x0151   (0x0003)  MISSED
	bool                                               bUseAsOccluder : 1;                                         // 0x0154:0 (0x0001)  
	unsigned char                                      UnknownData31_5[0x3];                                       // 0x0155   (0x0003)  MISSED
	...
	unsigned char                                      UnknownData32_6[0x2];                                       // 0x0302   (0x0002)  MISSED
	bool                                               bRenderCustomDepth : 1;                                     // 0x0304:0 (0x0001)  
	unsigned char                                      UnknownData33_5[0x3];                                       // 0x0305   (0x0003)  MISSED
	ERendererStencilMask                               CustomDepthStencilWriteMask;                                // 0x0308   (0x0001)  
	unsigned char                                      UnknownData34_6[0x3];                                       // 0x0309   (0x0003)  MISSED
	...
	unsigned char                                      UnknownData35_6[0x2];                                       // 0x033A   (0x0002)  MISSED
	...
	unsigned char                                      UnknownData36_5[0x1];                                       // 0x03DF   (0x0001)  MISSED
	...
	unsigned char                                      UnknownData37_7[0x3];                                       // 0x03F5   (0x0003)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData01_7[0x7];                                       // 0x0401   (0x0007)  MISSED
};
...
{ 
public:
	unsigned char                                      UnknownData02_8[0x50];                                      // 0x02C8   (0x0050)  MISSED
...
{ 
public:
	unsigned char                                      UnknownData01_1[0x10];                                      // 0x05E0   (0x0010)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData02_6[0xA0];                                      // 0x0030   (0x00A0)  MISSED
	TArray<FProceduralFoliageInstance>                 InstancesArray;                                             // 0x00D0   (0x0010)  
	unsigned char                                      UnknownData03_7[0x78];                                      // 0x00E0   (0x0078)  MISSED
};
