...
/// Size: 0x05C0 (1472 bytes) (0x000560 - 0x0005C0) align 16 MaxSize: 0x05C0
...
public:
    ...
    unsigned char                                      UnknownData00_6[0x2];                                       // 0x056A   (0x0002) MISSED
    ...
    unsigned char                                      UnknownData01_6[0x30];                                      // 0x057C   (0x0030) MISSED
    float                                              Duration;                                                   // 0x05AC   (0x0004)
    bool                                               bManualTick;                                                // 0x05B0   (0x0001)
    unsigned char                                      UnknownData02_7[0xF];                                       // 0x05B1   (0x000F) MISSED
