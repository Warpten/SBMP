...
public:
    ...
    unsigned char                                      UnknownData03_6[0x1];                                       // 0x004F   (0x0001) MISSED
    ...
    unsigned char                                      UnknownData05_7[0x2];                                       // 0x007E   (0x0002) MISSED
};
...
{ 
public:
    unsigned char                                      UnknownData01_1[0x8];                                       // 0x1B90   (0x0008) MISSED
};
...
public:
    ...
    unsigned char                                      UnknownData01_7[0x6];                                       // 0x07BA   (0x0006) MISSED
};
