...
public:
	...
	unsigned char                                      UnknownData05_6[0x2];                                       // 0x003A   (0x0002)  MISSED
	...
	unsigned char                                      UnknownData06_6[0x4];                                       // 0x0054   (0x0004)  MISSED
	...
	unsigned char                                      UnknownData07_7[0x1F];                                      // 0x0061   (0x001F)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData01_7[0x15];                                      // 0x0033   (0x0015)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData04_6[0x2];                                       // 0x005E   (0x0002)  MISSED
