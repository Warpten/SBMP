...
public:
	...
	unsigned char                                      UnknownData04_6[0x50];                                      // 0x0038   (0x0050)  MISSED
	class UAnimationSharingStateProcessor*             StateProcessor;                                             // 0x0088   (0x0008)  
	unsigned char                                      UnknownData05_6[0x38];                                      // 0x0090   (0x0038)  MISSED
	TArray<class UAnimSequence*>                       UsedAnimationSequences;                                     // 0x00C8   (0x0010)  
	unsigned char                                      UnknownData06_6[0x10];                                      // 0x00D8   (0x0010)  MISSED
	class UEnum*                                       StateEnum;                                                  // 0x00E8   (0x0008)  
	class AActor*                                      SharingActor;                                               // 0x00F0   (0x0008)  
	unsigned char                                      UnknownData07_7[0x20];                                      // 0x00F8   (0x0020)  MISSED
};
...
{ 
	...
	unsigned char                                      UnknownData05_6[0x2];                                       // 0x001A   (0x0002)  MISSED
	...
	unsigned char                                      UnknownData06_6[0x1];                                       // 0x0023   (0x0001)  MISSED
	...
	unsigned char                                      UnknownData07_7[0x3];                                       // 0x002D   (0x0003)  MISSED
};
