...
/// Size: 0x0490 (1168 bytes) (0x000260 - 0x000490) align 16 MaxSize: 0x0490
...
public:
    ...
    unsigned char                                      UnknownData02_7[0x110];                                     // 0x0380   (0x0110) MISSED
...
/// Size: 0x0A40 (2624 bytes) (0x000560 - 0x000A40) align 16 MaxSize: 0x0A40
class UGeometryCollectionComponent : public UMeshComponent
{ 
public:
    unsigned char                                      UnknownData00_8[0x8];                                       // 0x0560   (0x0008) MISSED
    class AChaosSolverActor*                           ChaosSolverActor;                                           // 0x0568   (0x0008)
    unsigned char                                      UnknownData01_6[0xE0];                                      // 0x0570   (0x00E0) MISSED
    ...
    unsigned char                                      UnknownData09_6[0x18];                                      // 0x0748   (0x0018) MISSED
    ...
    unsigned char                                      UnknownData10_6[0x3];                                       // 0x0775   (0x0003) MISSED
    ...
    unsigned char                                      UnknownData11_6[0x268];                                     // 0x07A8   (0x0268) MISSED
    class UBodySetup*                                  DummyBodySetup;                                             // 0x0A10   (0x0008)
    unsigned char                                      UnknownData12_7[0x28];                                      // 0x0A18   (0x0028) MISSED
...
/// Size: 0x03B0 (944 bytes) (0x0002C8 - 0x0003B0) align 8 MaxSize: 0x03B0
...
public:
    ...
    unsigned char                                      UnknownData01_6[0x3];                                       // 0x0311   (0x0003) MISSED
    ...
    unsigned char                                      UnknownData02_6[0x4];                                       // 0x037C   (0x0004) MISSED
    class UBillboardComponent*                         SpriteComponent;                                            // 0x0380   (0x0008)
    unsigned char                                      UnknownData03_7[0x28];                                      // 0x0388   (0x0028) MISSED
};
...
/// Size: 0x0360 (864 bytes) (0x0002C8 - 0x000360) align 16 MaxSize: 0x0360
...
public:
    ...
    unsigned char                                      UnknownData00_7[0x7E];                                      // 0x02E2   (0x007E) MISSED
};

/// Class /Script/GeometryCollectionEngine.SkeletalMeshSimulationComponent
/// Size: 0x0148 (328 bytes) (0x0000C0 - 0x000148) align 8 MaxSize: 0x0148
